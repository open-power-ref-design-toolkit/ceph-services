...
function run_ansible {
    ansible-playbook ${ANSIBLE_PARAMETERS} -i ceph-hosts --forks ${FORKS} $@
}
...
# These command line parameters are not specified if the inventory is generated by Genesis
infraNodes=""
storageNodes=""
computeNodes=""
OPTIND=1
